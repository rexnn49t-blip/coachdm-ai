                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <div className="rounded-xl border border-zinc-800 bg-black p-4 text-gray-300">
                      ...
                      I&apos;d love to know how it works and whether it&apos;s
                      right for me.
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="rounded-2xl border border-zinc-800 bg-black p-6">
                    <p className="leading-8 text-gray-300">
                      ...
                      Thanks so much for reaching out and for your interest in
                      my coaching program.
                      <br />
                      <br />

                      I&apos;d love to learn a little more about your goals so
                      I can share some information that may be helpful for you.
                      <br />
                      <br />
