...
import ExportReplies from "./ExportReplies";

export default function RepliesHeader() {
  return (
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-center">
          ...
          <div className="flex-1">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-400 sm:text-base">
              Browse, search, favorite and manage every AI reply you've
              generated. Quickly find past conversations and reuse your best
              responses whenever you need them.
            </p>
          </div>
        </div>
