  ...
  return (
    <main className="min-h-screen bg-black px-6 py-16 text-white">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-12 space-y-10 text-[15px] leading-7 text-zinc-300">
          <section>
          ...
          <section>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6">
              ...
              <li>Messages, notes, and conversation information you submit</li>
              <li>AI-generated replies and related usage information</li>
              <li>Subscription and account-plan information</li>
              <li>Technical information necessary to operate and secure the service</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              AI-generated content is produced automatically and may not always
              be accurate or appropriate. You are responsible for reviewing
              generated content before using or sending it.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              CoachDM AI uses third-party providers to operate different parts
              of the service. These may include providers for authentication,
              hosting, databases, artificial intelligence, payments, and
              email delivery.
            </p>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              or anonymize it in accordance with our operational and legal
              requirements.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              You should not submit sensitive information to CoachDM AI unless
              it is necessary, lawful, and appropriate for your use of the
              service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              access, correct, delete, restrict, or otherwise manage your
              information.
            </p>
          ...
          <section>
            ...
            <p className="mt-4">
              ...
              toward children. We do not knowingly collect personal information
